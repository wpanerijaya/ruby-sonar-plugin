...
public class Ruby extends AbstractLanguage {
	...
	static final String[] RUBY_KEYWORDS_ARRAY = new String[] { "alias", "and",
			"BEGIN", "begin", "break", "case", "class", "def", "defined?",
			"do", "else", "elsif", "END", "end", "ensure", "false", "for",
	...
	public String[] getFileSuffixes() {
		// WP
		return new String[] { ".rb", ".rake" };
		// return new String[]{".rb", ".erb"};
	}
}
